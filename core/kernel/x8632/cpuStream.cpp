...
cpuId(cid), bankId(bid), scheduler(this)
{
	 ...
	 *
	 * For the cpuStreamC class, there is a single global object. It is the
	 * statically allocated space for the bootstrap processor's most basic
	 * task and scheduling info.
	 *
