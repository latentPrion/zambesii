...
error_t taskTribC::schedule(Thread *task)
{
...
error_t taskTribC::dormant(Task *task, TaskContext *perCpuContext)
{
	cpuStreamC	*TaskurrentCpu;
...
error_t taskTribC::wake(Task *task, TaskContext *perCpuContext)
{
	TaskContext	*tmpContext;
	Thread		*thread;
...
void taskTribC::block(Lock::operationDescriptorS *unlockDescriptor)
{
	Task		*currTask;
...
error_t taskTribC::unblock(Task *task, TaskContext *perCpuContext)
{
	TaskContext	*tmpContext;
	Thread		*thread;
