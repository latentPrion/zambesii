...
public:
	...
	Task(processStreamC *parent, void *privateData)
	:
...
friend class processStreamC;
public:
	Thread(processId_t id, processStreamC *parent, void *privateData)
	:
...
{
public:
	PerCpuThread(processStreamC *parent, void *privateData)
	:
	Task(parent, privateData)
	{}
