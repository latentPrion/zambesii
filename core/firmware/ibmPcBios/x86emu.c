...
static void 	x86emu_intr_raise (struct x86emu *, ubit8 type);
...
static ubit8	fetch_byte_imm (struct x86emu *);
static ubit16	fetch_word_imm (struct x86emu *);
static ubit32	fetch_long_imm (struct x86emu *);
static ubit8	fetch_data_byte (struct x86emu *, ubit32 offset);
static ubit8	fetch_byte (struct x86emu *, ubit32 segment, ubit32 offset);
static ubit16	fetch_data_word (struct x86emu *, ubit32 offset);
static ubit16	fetch_word (struct x86emu *, ubit32 segment, ubit32 offset);
static ubit32	fetch_data_long (struct x86emu *, ubit32 offset);
static ubit32	fetch_long (struct x86emu *, ubit32 segment, ubit32 offset);
static void	store_data_byte (struct x86emu *, ubit32 offset, ubit8 val);
static void	store_byte (struct x86emu *, ubit32 segment, ubit32 offset, ubit8 val);
static void	store_data_word (struct x86emu *, ubit32 offset, ubit16 val);
static void	store_word (struct x86emu *, ubit32 segment, ubit32 offset, ubit16 val);
static void	store_data_long (struct x86emu *, ubit32 offset, ubit32 val);
static void	store_long (struct x86emu *, ubit32 segment, ubit32 offset, ubit32 val);
static ubit8*	decode_rl_byte_register(struct x86emu *);
static ubit16*	decode_rl_word_register(struct x86emu *);
static ubit32* 	decode_rl_long_register(struct x86emu *);
static ubit8* 	decode_rh_byte_register(struct x86emu *);
static ubit16* 	decode_rh_word_register(struct x86emu *);
static ubit32* 	decode_rh_long_register(struct x86emu *);
static ubit16* 	decode_rh_seg_register(struct x86emu *);
static ubit32	decode_rl_address(struct x86emu *);

static ubit8 	decode_and_fetch_byte(struct x86emu *);
static ubit16 	decode_and_fetch_word(struct x86emu *);
static ubit32 	decode_and_fetch_long(struct x86emu *);

static ubit8 	decode_and_fetch_byte_imm8(struct x86emu *, ubit8 *);
static ubit16 	decode_and_fetch_word_imm8(struct x86emu *, ubit8 *);
static ubit32 	decode_and_fetch_long_imm8(struct x86emu *, ubit8 *);

static ubit16 	decode_and_fetch_word_disp(struct x86emu *, sbit16);
static ubit32 	decode_and_fetch_long_disp(struct x86emu *, sbit16);

static void	write_back_byte(struct x86emu *, ubit8);
static void	write_back_word(struct x86emu *, ubit16);
static void	write_back_long(struct x86emu *, ubit32);

static ubit16	aaa_word (struct x86emu *, ubit16 d);
static ubit16	aas_word (struct x86emu *, ubit16 d);
static ubit16	aad_word (struct x86emu *, ubit16 d);
static ubit16	aam_word (struct x86emu *, ubit8 d);
static ubit8	adc_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	adc_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	adc_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	add_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	add_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	add_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	and_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	and_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	and_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	cmp_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	cmp_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	cmp_long (struct x86emu *, ubit32 d, ubit32 s);
static void	cmp_byte_no_return (struct x86emu *, ubit8 d, ubit8 s);
static void	cmp_word_no_return (struct x86emu *, ubit16 d, ubit16 s);
static void	cmp_long_no_return (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	daa_byte (struct x86emu *, ubit8 d);
static ubit8	das_byte (struct x86emu *, ubit8 d);
static ubit8	dec_byte (struct x86emu *, ubit8 d);
static ubit16	dec_word (struct x86emu *, ubit16 d);
static ubit32	dec_long (struct x86emu *, ubit32 d);
static ubit8	inc_byte (struct x86emu *, ubit8 d);
static ubit16	inc_word (struct x86emu *, ubit16 d);
static ubit32	inc_long (struct x86emu *, ubit32 d);
static ubit8	or_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	or_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	or_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	neg_byte (struct x86emu *, ubit8 s);
static ubit16	neg_word (struct x86emu *, ubit16 s);
static ubit32	neg_long (struct x86emu *, ubit32 s);
static ubit8	rcl_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	rcl_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	rcl_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	rcr_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	rcr_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	rcr_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	rol_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	rol_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	rol_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	ror_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	ror_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	ror_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	shl_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	shl_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	shl_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	shr_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	shr_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	shr_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit8	sar_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	sar_word (struct x86emu *, ubit16 d, ubit8 s);
static ubit32	sar_long (struct x86emu *, ubit32 d, ubit8 s);
static ubit16	shld_word (struct x86emu *, ubit16 d, ubit16 fill, ubit8 s);
static ubit32	shld_long (struct x86emu *, ubit32 d, ubit32 fill, ubit8 s);
static ubit16	shrd_word (struct x86emu *, ubit16 d, ubit16 fill, ubit8 s);
static ubit32	shrd_long (struct x86emu *, ubit32 d, ubit32 fill, ubit8 s);
static ubit8	sbb_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	sbb_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	sbb_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	sub_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	sub_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	sub_long (struct x86emu *, ubit32 d, ubit32 s);
static void	test_byte (struct x86emu *, ubit8 d, ubit8 s);
static void	test_word (struct x86emu *, ubit16 d, ubit16 s);
static void	test_long (struct x86emu *, ubit32 d, ubit32 s);
static ubit8	xor_byte (struct x86emu *, ubit8 d, ubit8 s);
static ubit16	xor_word (struct x86emu *, ubit16 d, ubit16 s);
static ubit32	xor_long (struct x86emu *, ubit32 d, ubit32 s);
static void	imul_byte (struct x86emu *, ubit8 s);
static void	imul_word (struct x86emu *, ubit16 s);
static void	imul_long (struct x86emu *, ubit32 s);
static void	mul_byte (struct x86emu *, ubit8 s);
static void	mul_word (struct x86emu *, ubit16 s);
static void	mul_long (struct x86emu *, ubit32 s);
static void	idiv_byte (struct x86emu *, ubit8 s);
static void	idiv_word (struct x86emu *, ubit16 s);
static void	idiv_long (struct x86emu *, ubit32 s);
static void	div_byte (struct x86emu *, ubit8 s);
static void	div_word (struct x86emu *, ubit16 s);
static void	div_long (struct x86emu *, ubit32 s);
static void	ins (struct x86emu *, int size);
static void	outs (struct x86emu *, int size);
static void	push_word (struct x86emu *, ubit16 w);
static void	push_long (struct x86emu *, ubit32 w);
static ubit16	pop_word (struct x86emu *);
static ubit32	pop_long (struct x86emu *);
 ...
 */
static void
x86emu_intr_dispatch(struct x86emu *emu, ubit8 intno)
{
	if (emu->_x86emu_intrTab[intno]) {
		(*emu->_x86emu_intrTab[intno]) (emu, intno);
	} else {
		push_word(emu, (ubit16) emu->x86.R_FLG);
		CLEAR_FLAG(F_IF);
		CLEAR_FLAG(F_TF);
 ...
 */
void 
x86emu_intr_raise(struct x86emu *emu, ubit8 intrnum)
{
...
void
x86emu_exec_call(struct x86emu *emu, ubit16 seg, ubit16 off)
{
	push_word(emu, 0);
	push_word(emu, 0);
	emu->x86.R_CS = seg;
...
void
x86emu_exec_intr(struct x86emu *emu, ubit8 intr)
{
 ...
 */
static ubit8 
fetch_data_byte(struct x86emu *emu, ubit32 offset)
{
 ...
 */
static ubit16 
fetch_data_word(struct x86emu *emu, ubit32 offset)
{
 ...
 */
static ubit32 
fetch_data_long(struct x86emu *emu, ubit32 offset)
{
 ...
 */
static ubit8 
fetch_byte(struct x86emu *emu, ubit32 segment, ubit32 offset)
{
	return (*emu->emu_rdb) (emu, ((ubit32) segment << 4) + offset);
}
 ...
 */
static ubit16 
fetch_word(struct x86emu *emu, ubit32 segment, ubit32 offset)
{
	return (*emu->emu_rdw) (emu, ((ubit32) segment << 4) + offset);
}
 ...
 */
static ubit32 
fetch_long(struct x86emu *emu, ubit32 segment, ubit32 offset)
{
	return (*emu->emu_rdl) (emu, ((ubit32) segment << 4) + offset);
}
 ...
 */
static void 
store_data_byte(struct x86emu *emu, ubit32 offset, ubit8 val)
{
 ...
 */
static void 
store_data_word(struct x86emu *emu, ubit32 offset, ubit16 val)
{
 ...
 */
static void 
store_data_long(struct x86emu *emu, ubit32 offset, ubit32 val)
{
 ...
 */
static void 
store_byte(struct x86emu *emu, ubit32 segment, ubit32 offset, ubit8 val)
{
	(*emu->emu_wrb) (emu, ((ubit32) segment << 4) + offset, val);
}
 ...
 */
static void 
store_word(struct x86emu *emu, ubit32 segment, ubit32 offset, ubit16 val)
{
	(*emu->emu_wrw) (emu, ((ubit32) segment << 4) + offset, val);
}
 ...
 */
static void 
store_long(struct x86emu *emu, ubit32 segment, ubit32 offset, ubit32 val)
{
	(*emu->emu_wrl) (emu, ((ubit32) segment << 4) + offset, val);
}
...
decode_rl_address(struct x86emu *emu)
{
	if (emu->x86.mode & SYSMODE_PREFIX_ADDR) {
		...
		if (emu->cur_mod == 1)
			offset += (sbit8)fetch_byte_imm(emu);
...
static ubit16
decode_and_fetch_word_disp(struct x86emu *emu, sbit16 disp)
{
	if (emu->cur_mod != 3) {
...
static ubit32
decode_and_fetch_long_disp(struct x86emu *emu, sbit16 disp)
{
	if (emu->cur_mod != 3) {
		/* TODO: A20 gate emulation */
		emu->cur_offset = decode_rl_address(emu) + disp;
...
ubit8
decode_and_fetch_byte_imm8(struct x86emu *emu, ubit8 *imm)
{
	if (emu->cur_mod != 3) {
		emu->cur_offset = decode_rl_address(emu);
...
static ubit16
decode_and_fetch_word_imm8(struct x86emu *emu, ubit8 *imm)
{
	if (emu->cur_mod != 3) {
		emu->cur_offset = decode_rl_address(emu);
		*imm = fetch_byte_imm(emu);
...
static ubit32
decode_and_fetch_long_imm8(struct x86emu *emu, ubit8 *imm)
{
	if (emu->cur_mod != 3) {
		emu->cur_offset = decode_rl_address(emu);
		*imm = fetch_byte_imm(emu);
...
static void
write_back_byte(struct x86emu *emu, ubit8 val)
{
	if (emu->cur_mod != 3)
...
static void
write_back_word(struct x86emu *emu, ubit16 val)
{
	if (emu->cur_mod != 3)
...
static void
write_back_long(struct x86emu *emu, ubit32 val)
{
	if (emu->cur_mod != 3)
...
common_binop_byte_rm_r(struct x86emu *emu, 
    ubit8 (*binop)(struct x86emu *, ubit8, ubit8))
{
	ubit32 destoffset;
	ubit8 *destreg, srcval;
	ubit8 destval;
...
common_binop_ns_byte_rm_r(struct x86emu *emu, 
    void (*binop)(struct x86emu *, ubit8, ubit8))
{
	ubit32 destoffset;
	ubit8 destval, srcval;
...
common_binop_word_rm_r(struct x86emu *emu,
    ubit16 (*binop)(struct x86emu *, ubit16, ubit16))
{
	ubit32 destoffset;
	ubit16 destval, *destreg, srcval;
...
common_binop_long_rm_r(struct x86emu *emu,
    ubit32 (*binop)(struct x86emu *, ubit32, ubit32))
{
	ubit32 destoffset;
	ubit32 destval, *destreg, srcval;
...
common_binop_word_long_rm_r(struct x86emu *emu,
    ubit16 (*binop16)(struct x86emu *, ubit16, ubit16),
    ubit32 (*binop32)(struct x86emu *, ubit32, ubit32))
{
	if (emu->x86.mode & SYSMODE_PREFIX_DATA)
...
common_binop_ns_word_rm_r(struct x86emu *emu,
    void (*binop)(struct x86emu *, ubit16, ubit16))
{
	ubit32 destoffset;
	ubit16 destval, srcval;
...
common_binop_ns_long_rm_r(struct x86emu *emu,
    void (*binop)(struct x86emu *, ubit32, ubit32))
{
	ubit32 destoffset;
	ubit32 destval, srcval;
...
common_binop_ns_word_long_rm_r(struct x86emu *emu,
    void (*binop16)(struct x86emu *, ubit16, ubit16),
    void (*binop32)(struct x86emu *, ubit32, ubit32))
{
	if (emu->x86.mode & SYSMODE_PREFIX_DATA)
...
common_imul_long_IMM(struct x86emu *emu, int byte_imm)
{
	...
	if (byte_imm)
		imm = (sbit8)fetch_byte_imm(emu);
	else
		imm = fetch_long_imm(emu);
	res = (sbit32)srcval * imm;
...
common_jmp_near(struct x86emu *emu, int cond)
{
	...
	offset = (sbit8) fetch_byte_imm(emu);
	target = (ubit16) (emu->x86.R_IP + (sbit16) offset);
	if (cond)
		emu->x86.R_IP = target;
}

static void
common_load_far_pointer(struct x86emu *emu, ubit16 *seg)
{
	ubit16 *dstreg;
	ubit32 srcoffset;
...
static
ubit8(*const opc80_byte_operation[]) (struct x86emu *, ubit8 d, ubit8 s) =
{
	add_byte,		/* 00 */
	or_byte,		/* 01 */
	adc_byte,		/* 02 */
...
static
ubit16(* const opc81_word_operation[])
    (struct x86emu *, ubit16 d, ubit16 s) =
{
	add_word,		/* 00 */
	or_word,		/* 01 */
	adc_word,		/* 02 */
...
static
ubit32(* const opc81_long_operation[])
    (struct x86emu *, ubit32 d, ubit32 s) =
{
	add_long,		/* 00 */
	or_long,		/* 01 */
	adc_long,		/* 02 */
...
static
ubit8(* const opc82_byte_operation[])
    (struct x86emu *, ubit8 s, ubit8 d) =
{
	add_byte,		/* 00 */
...
static
ubit16(* const opc83_word_operation[])
    (struct x86emu *, ubit16 s, ubit16 d) =
{
	add_word,		/* 00 */
...
static
ubit32(* const opc83_long_operation[])
    (struct x86emu *, ubit32 s, ubit32 d) =
{
	add_long,		/* 00 */
...
{
	emu->x86.R_AH = (ubit8) (emu->x86.R_FLG & 0xff);
		...
		while (emu->x86.R_CX != 0) {
			if (emu->x86.mode & SYSMODE_PREFIX_DATA) {
				...
				val2 = fetch_word(emu, emu->x86.R_ES,
				    emu->x86.R_DI);
				cmp_word(emu, (ubit16) val1, (ubit16) val2);
			}
			emu->x86.R_CX -= 1;
			emu->x86.R_SI += inc;
			emu->x86.R_DI += inc;
		...
		while (emu->x86.R_CX != 0) {
			if (emu->x86.mode & SYSMODE_PREFIX_DATA) {
				...
				val = fetch_word(emu, emu->x86.R_ES,
				    emu->x86.R_DI);
				cmp_word(emu, emu->x86.R_AX, (ubit16) val);
			}
			emu->x86.R_CX -= 1;
			emu->x86.R_DI += inc;
			if (ACCESS_FLAG(F_ZF) == 0)
...
static
ubit8(* const opcD0_byte_operation[])
    (struct x86emu *, ubit8 d, ubit8 s) =
{
	rol_byte,
	ror_byte,
	rcl_byte,
...
static
ubit16(* const opcD1_word_operation[])
    (struct x86emu *, ubit16 s, ubit8 d) =
{
	rol_word,
	ror_word,
	rcl_word,
...
/* used by opcodes c1, d1, and d3. */
static
ubit32(* const opcD1_long_operation[])
    (struct x86emu *, ubit32 s, ubit8 d) =
{
	rol_long,
	ror_long,
	rcl_long,
...
x86emuOp_enter(struct x86emu *emu)
{
	...
	emu->x86.R_SP = (ubit16) (emu->x86.R_SP - local);
}
...
x86emuOp_aam(struct x86emu *emu)
{
	...
	if (a != 10) {
		/* fix: add base decoding aam_word(ubit8 val, int base a) */
		x86emu_halt_sys(emu);
	}
...
x86emuOp_aad(struct x86emu *emu)
{
	...
	if (a != 10) {
		/* fix: add base decoding aad_word(ubit16 val, int base a) */
		x86emu_halt_sys(emu);
	}
...
x86emuOp_xlat(struct x86emu *emu)
{
	...
	addr = (ubit16) (emu->x86.R_BX + (ubit8) emu->x86.R_AL);
...
x86emuOp_loopne(struct x86emu *emu)
{
	...
	ip = (sbit8) fetch_byte_imm(emu);
	ip += (sbit16) emu->x86.R_IP;
	emu->x86.R_CX -= 1;
...
x86emuOp_jcxz(struct x86emu *emu)
{
	...
	offset = (sbit8) fetch_byte_imm(emu);
	target = (ubit16) (emu->x86.R_IP + offset);
	if (emu->x86.R_CX == 0)
		emu->x86.R_IP = target;
}
...
x86emuOp_call_near_IMM(struct x86emu *emu)
{
	...
	ip = (sbit16) fetch_word_imm(emu);
	ip += (sbit16) emu->x86.R_IP;	/* CHECK SIGN */
	push_word(emu, emu->x86.R_IP);
	emu->x86.R_IP = ip;
}
...
common_jmp_long(struct x86emu *emu, int cond)
{
	...
	target = (sbit16) fetch_word_imm(emu);
	target += (sbit16) emu->x86.R_IP;
	if (cond)
		emu->x86.R_IP = (ubit16) target;
}
...
{
	int bit;
	ubit32 srcval, *shiftreg, mask;

	fetch_decode_modrm(emu);
	shiftreg = decode_rh_long_register(emu);
	srcval = decode_and_fetch_long_disp(emu, (sbit16) *shiftreg >> 5);
	bit = *shiftreg & 0x1F;
	mask =  0x1 << bit;
...
{
	int bit;
	ubit16 srcval, *shiftreg, mask;

	fetch_decode_modrm(emu);
	shiftreg = decode_rh_word_register(emu);
	srcval = decode_and_fetch_word_disp(emu, (sbit16) *shiftreg >> 4);
	bit = *shiftreg & 0xF;
	mask =  0x1 << bit;
	CONDITIONAL_SET_FLAG(srcval & mask, F_CF);
...
static void
hw_cpuid(ubit32 *a, ubit32 *b, ubit32 *c, ubit32 *d)
{
...
x86emuOp2_32_imul_R_RM(struct x86emu *emu)
{
	...
	destreg = decode_rh_long_register(emu);
	srcval = decode_and_fetch_long(emu);
	res = (sbit32) *destreg * (sbit32)srcval;
	if (res > 0xffffffff) {
		SET_FLAG(F_CF);
		SET_FLAG(F_OF);
	} else {
...
x86emuOp2_16_imul_R_RM(struct x86emu *emu)
{
	...
	destreg = decode_rh_word_register(emu);
	srcval = decode_and_fetch_word(emu);
	res = (sbit16) * destreg * (sbit16)srcval;
	if (res > 0xFFFF) {
		SET_FLAG(F_CF);
		SET_FLAG(F_OF);
	} else {
...
x86emuOp2_32_movsx_byte_R_RM(struct x86emu *emu)
{
	...
	destreg = decode_rh_long_register(emu);
	*destreg = (sbit32)(sbit8)decode_and_fetch_byte(emu);
}
...
x86emuOp2_16_movsx_byte_R_RM(struct x86emu *emu)
{
	...
	fetch_decode_modrm(emu);
	destreg = decode_rh_word_register(emu);
	*destreg = (sbit16)(sbit8)decode_and_fetch_byte(emu);
}
...
x86emuOp2_movsx_word_R_RM(struct x86emu *emu)
{
	...
	fetch_decode_modrm(emu);
	destreg = decode_rh_long_register(emu);
	*destreg = (sbit32)(sbit16)decode_and_fetch_word(emu);
}
...
static ubit32 x86emu_parity_tab[8] =
{
	0x96696996,
	0x69969669,
	0x69969669,
 ...
 */
static ubit16 
aaa_word(struct x86emu *emu, ubit16 d)
{
	ubit16 res;
 ...
 */
static ubit16 
aas_word(struct x86emu *emu, ubit16 d)
{
	ubit16 res;
	if ((d & 0xf) > 0x9 || ACCESS_FLAG(F_AF)) {
		d -= 0x6;
 ...
 */
static ubit16 
aad_word(struct x86emu *emu, ubit16 d)
{
	ubit16 l;
	ubit8 hb, lb;
 ...
 */
static ubit16 
aam_word(struct x86emu *emu, ubit8 d)
{
	ubit16 h, l;
 ...
 */
static ubit8 
adc_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit16 
adc_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit32 
adc_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 lo;	/* all operands in native machine order */
	ubit32 hi;
	ubit32 res;
	ubit32 cc;
 ...
 */
static ubit8 
add_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit16 
add_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit32 
add_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 lo;	/* all operands in native machine order */
	ubit32 hi;
	ubit32 res;
 ...
 */
static ubit8 
and_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit8 res;	/* all operands in native machine order */
 ...
 */
static ubit16 
and_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit16 res;	/* all operands in native machine order */
 ...
 */
static ubit32 
and_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static ubit8 
cmp_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
...
static void 
cmp_byte_no_return(struct x86emu *emu, ubit8 d, ubit8 s)
{
	cmp_byte(emu, d, s);
}
 ...
 */
static ubit16 
cmp_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
...
static void 
cmp_word_no_return(struct x86emu *emu, ubit16 d, ubit16 s)
{
	cmp_word(emu, d, s);
}
 ...
 */
static ubit32 
cmp_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
...
static void 
cmp_long_no_return(struct x86emu *emu, ubit32 d, ubit32 s)
{
	cmp_long(emu, d, s);
}
 ...
 */
static ubit8 
daa_byte(struct x86emu *emu, ubit8 d)
{
	ubit32 res = d;
 ...
 */
static ubit8 
das_byte(struct x86emu *emu, ubit8 d)
{
	if ((d & 0xf) > 9 || ACCESS_FLAG(F_AF)) {
		d -= 6;
		SET_FLAG(F_AF);
 ...
 */
static ubit8 
dec_byte(struct x86emu *emu, ubit8 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit16 
dec_word(struct x86emu *emu, ubit16 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit32 
dec_long(struct x86emu *emu, ubit32 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit8 
inc_byte(struct x86emu *emu, ubit8 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit16 
inc_word(struct x86emu *emu, ubit16 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit32 
inc_long(struct x86emu *emu, ubit32 d)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 cc;
 ...
 */
static ubit8 
or_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit8 res;	/* all operands in native machine order */
 ...
 */
static ubit16 
or_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit16 res;	/* all operands in native machine order */
 ...
 */
static ubit32 
or_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static ubit8 
neg_byte(struct x86emu *emu, ubit8 s)
{
	ubit8 res;
	ubit8 bc;
 ...
 */
static ubit16 
neg_word(struct x86emu *emu, ubit16 s)
{
	ubit16 res;
	ubit16 bc;
 ...
 */
static ubit32 
neg_long(struct x86emu *emu, ubit32 s)
{
	ubit32 res;
	ubit32 bc;
 ...
 */
static ubit8 
rcl_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
 ...
 */
static ubit16 
rcl_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int res, cnt, mask, cf;
 ...
 */
static ubit32 
rcl_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	ubit32 res, cnt, mask, cf;
 ...
 */
static ubit8 
rcr_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res, cnt;
	ubit32 mask, cf, ocf = 0;
 ...
 */
static ubit16 
rcr_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	ubit32 res, cnt;
	ubit32 mask, cf, ocf = 0;
 ...
 */
static ubit32 
rcr_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	ubit32 res, cnt;
	ubit32 mask, cf, ocf = 0;
 ...
 */
static ubit8 
rol_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
 ...
 */
static ubit16 
rol_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int res, cnt, mask;
 ...
 */
static ubit32 
rol_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	ubit32 res, cnt, mask;
 ...
 */
static ubit8 
ror_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	unsigned int res, cnt, mask;
 ...
 */
static ubit16 
ror_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int res, cnt, mask;
 ...
 */
static ubit32 
ror_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	ubit32 res, cnt, mask;
 ...
 */
static ubit8 
shl_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
 ...
 */
static ubit16 
shl_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit32 
shl_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit8 
shr_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit16 
shr_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit32 
shr_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit8 
sar_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
 ...
 */
static ubit16 
sar_word(struct x86emu *emu, ubit16 d, ubit8 s)
{
	unsigned int cnt, res, cf, mask, sf;
 ...
 */
static ubit32 
sar_long(struct x86emu *emu, ubit32 d, ubit8 s)
{
	ubit32 cnt, res, cf, mask, sf;
 ...
 */
static ubit16 
shld_word(struct x86emu *emu, ubit16 d, ubit16 fill, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit32 
shld_long(struct x86emu *emu, ubit32 d, ubit32 fill, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit16 
shrd_word(struct x86emu *emu, ubit16 d, ubit16 fill, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit32 
shrd_long(struct x86emu *emu, ubit32 d, ubit32 fill, ubit8 s)
{
	unsigned int cnt, res, cf;
 ...
 */
static ubit8 
sbb_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit16 
sbb_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit32 
sbb_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit8 
sub_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit16 
sub_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static ubit32 
sub_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
	ubit32 bc;
 ...
 */
static void 
test_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static void 
test_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static void 
test_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static ubit8 
xor_byte(struct x86emu *emu, ubit8 d, ubit8 s)
{
	ubit8 res;	/* all operands in native machine order */
 ...
 */
static ubit16 
xor_word(struct x86emu *emu, ubit16 d, ubit16 s)
{
	ubit16 res;	/* all operands in native machine order */
 ...
 */
static ubit32 
xor_long(struct x86emu *emu, ubit32 d, ubit32 s)
{
	ubit32 res;	/* all operands in native machine order */
 ...
 */
static void 
imul_byte(struct x86emu *emu, ubit8 s)
{
	sbit16 res = (sbit16) ((sbit8) emu->x86.R_AL * (sbit8) s);
 ...
 */
static void 
imul_word(struct x86emu *emu, ubit16 s)
{
	sbit32 res = (sbit16) emu->x86.R_AX * (sbit16) s;

	emu->x86.R_AX = (ubit16) res;
	emu->x86.R_DX = (ubit16) (res >> 16);
 ...
 */
static void 
imul_long(struct x86emu *emu, ubit32 s)
{
	int64_t res;
	
	res = (int64_t)(sbit32)emu->x86.R_EAX * (sbit32)s;
	emu->x86.R_EAX = (ubit32)res;
 ...
 */
static void 
mul_byte(struct x86emu *emu, ubit8 s)
{
	ubit16 res = (ubit16) (emu->x86.R_AL * s);
 ...
 */
static void 
mul_word(struct x86emu *emu, ubit16 s)
{
	ubit32 res = emu->x86.R_AX * s;
 ...
 */
static void 
mul_long(struct x86emu *emu, ubit32 s)
{
	uint64_t res = (uint64_t) emu->x86.R_EAX * s;

	emu->x86.R_EAX = (ubit32) res;
	emu->x86.R_EDX = (ubit32) (res >> 32);
 ...
 */
static void 
idiv_byte(struct x86emu *emu, ubit8 s)
{
	sbit32 dvd, div, mod;

	dvd = (sbit16) emu->x86.R_AX;
	if (s == 0) {
	...
	emu->x86.R_AL = (sbit8) div;
	emu->x86.R_AH = (sbit8) mod;
}
 ...
 */
static void 
idiv_word(struct x86emu *emu, ubit16 s)
{
	sbit32 dvd, div, mod;

	dvd = (((sbit32) emu->x86.R_DX) << 16) | emu->x86.R_AX;
	if (s == 0) {
		x86emu_intr_raise(emu, 8);
		return;
	}
	...
	emu->x86.R_AX = (ubit16) div;
	emu->x86.R_DX = (ubit16) mod;
}
 ...
 */
static void 
idiv_long(struct x86emu *emu, ubit32 s)
{
	int64_t dvd, div, mod;
	...
	emu->x86.R_EAX = (ubit32) div;
	emu->x86.R_EDX = (ubit32) mod;
}
 ...
 */
static void 
div_byte(struct x86emu *emu, ubit8 s)
{
	ubit32 dvd, div, mod;
	...
	emu->x86.R_AL = (ubit8) div;
	emu->x86.R_AH = (ubit8) mod;
}
 ...
 */
static void 
div_word(struct x86emu *emu, ubit16 s)
{
	ubit32 dvd, div, mod;

	dvd = (((ubit32) emu->x86.R_DX) << 16) | emu->x86.R_AX;
	if (s == 0) {
		x86emu_intr_raise(emu, 8);
		return;
	}
 ...
 */
static void 
div_long(struct x86emu *emu, ubit32 s)
{
...
ins(struct x86emu *emu, int size)
{
	...
	if (emu->x86.mode & (SYSMODE_PREFIX_REPE | SYSMODE_PREFIX_REPNE)) {
		/* dont care whether REPE or REPNE */
		/* in until CX is ZERO. */
		ubit32 count = ((emu->x86.mode & SYSMODE_PREFIX_DATA) ?
 ...
 */
static void 
push_word(struct x86emu *emu, ubit16 w)
{
	emu->x86.R_SP -= 2;
 ...
 */
static void 
push_long(struct x86emu *emu, ubit32 w)
{
	emu->x86.R_SP -= 4;
