...
enum TimerStreamOneshotType {
	TIMERSTREAM_CREATEONESHOT_TYPE_ABSOLUTE = 0x0,
	TIMERSTREAM_CREATEONESHOT_TYPE_RELATIVE = 0x1,
	TIMERSTREAM_CREATEONESHOT_TYPE_ENUM_END
};
#define TIMERSTREAM_CREATEONESHOT_TYPE_MAXVAL		(TIMERSTREAM_CREATEONESHOT_TYPE_ENUM_END - 1)
