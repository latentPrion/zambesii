...
// Used to define the CPU vectors for each class of IRQ: pin-based and MSI IRQs.
#define ARCH_INTERRUPTS_VECTOR_PIN_START	(32)
#define ARCH_INTERRUPTS_VECTOR_PIN_MAXNUM	(108)
#define ARCH_INTERRUPTS_VECTOR_MSI_START	\
	(ARCH_INTERRUPTS_VECTOR_PIN_START + ARCH_INTERRUPTS_VECTOR_PIN_MAXNUM)
#define ARCH_INTERRUPTS_VECTOR_MSI_MAXNUM	(108)

#define ARCH_INTERRUPTS_VECTOR_SWI		(248)
