...
status_t ZkcmIrqControlMod::Bpm::loadBusPinMappings(utf8Char *bus)
{
...
error_t ZkcmIrqControlMod::Bpm::get__kpinFor(
 ...
 **/
status_t ZkcmIrqControlMod::Bpm::maskIrq(utf8Char *bus, ubit32 busIrqId)
{
	if (strcmp8(bus, CC"isa") == 0) {
...
status_t ZkcmIrqControlMod::Bpm::unmaskIrq(utf8Char *bus, ubit32 busIrqId)
{
	if (strcmp8(bus, CC"isa") == 0) {
